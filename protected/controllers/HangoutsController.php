...
class HangoutsController extends Controller 
{
	...
	public function actionNovo() 
	{
		...
		$this->redirect($this->createUrl('hangouts/index'));
	}
	...
	{
		$model=(is_null($this->_model)) ? new Hangouts : $this->_model;	
		$dataProvider = new CActiveDataProvider('Hangouts', array(
			'criteria'=>array(
				'with'=>array('idUsuario0'),
			),
		));
